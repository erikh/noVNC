...
this._encHandlers[_encodings.encodings.encodingRaw]=RFB.encodingHandlers.RAW.bind(this);this._encHandlers[_encodings.encodings.encodingCopyRect]=RFB.encodingHandlers.COPYRECT.bind(this);this._encHandlers[_encodings.encodings.encodingRRE]=RFB.encodingHandlers.RRE.bind(this);this._encHandlers[_encodings.encodings.encodingHextile]=RFB.encodingHandlers.HEXTILE.bind(this);this._encHandlers[_encodings.encodings.encodingTight]=RFB.encodingHandlers.TIGHT.bind(this);this._encHandlers[_encodings.encodings.encodingTightPNG]=RFB.encodingHandlers.TIGHT.bind(this);this._encHandlers[_encodings.encodings.pseudoEncodingDesktopSize]=RFB.encodingHandlers.DesktopSize.bind(this);this._encHandlers[_encodings.encodings.pseudoEncodingLastRect]=RFB.encodingHandlers.last_rect.bind(this);this._encHandlers[_encodings.encodings.pseudoEncodingCursor]=RFB.encodingHandlers.Cursor.bind(this);this._encHandlers[_encodings.encodings.pseudoEncodingQEMUExtendedKeyEvent]=RFB.encodingHandlers.QEMUExtendedKeyEvent.bind(this);this._encHandlers[_encodings.encodings.pseudoEncodingExtendedDesktopSize]=RFB.encodingHandlers.ExtendedDesktopSize.bind(this);// NB: nothing that needs explicit teardown should be done
...
try{var keyboardEvent=document.createEvent('keyboardEvent');if(keyboardEvent.code!==undefined){this._qemuExtKeyEventSupported=true}}catch(err){}}};